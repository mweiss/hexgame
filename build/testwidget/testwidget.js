YUI.add('testwidget', function(Y) {


/**
 * FIXME: Enter a description for the testwidget module
 * @module testwidget
 */

/**
 * FIXME: Enter a description for the Testwidget class
 * @class Testwidget
 * @extends Widget
 * @constructor
 */
var Testwidget = Y.Base.create("testwidget", Y.Widget, [/*Y.WidgetParent*/], {
   ...
   initializer: function() {
     ...
     // Get localized strings in the current language
      this.resources = Y.Intl.get("testwidget");
   ...
   renderUI : function() {
        ...
        */
        ...
        // this._mynode = Node.create(Y.substitute(Testwidget.MYNODE_TEMPLATE, {mynodeid: this.get("id") + "_mynode"})); 
   },
   ...
   // Beyond this point is the Testwidget specific application and rendering logic
...
Y.Testwidget = Testwidget;


}, '@VERSION@' ,{use:['widget','intl']});
